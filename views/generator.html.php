		...
		if($tab == 'flashcards'):?>
			...
			<form method="post" enctype="multipart/form-data">
				   ...
				   <p><label><?php _e('Border radius:', 'shortcode-revolution');?></label> <input type="text" name="card_radius" value="<?php echo empty($_POST['card_radius']) ? '0%' : esc_attr($_POST['card_radius']);?>"></p>
		    		...
		    		<p><label><?php _e('Front text color:', 'shortcode-revolution');?></label> <input type="text" name="card_front_text_color" value="<?php echo empty($_POST['card_front_text_color']) ? 'black' : esc_attr($_POST['card_front_text_color'])?>" class="srevo-color-field"></p>
					...
					<p><label><?php _e('Back text color:', 'shortcode-revolution');?></label> <input type="text" name="card_back_text_color" value="<?php echo empty($_POST['card_back_text_color']) ? 'black' : esc_attr($_POST['card_back_text_color'])?>" class="srevo-color-field"></p>		    		
	    		...
	    		<?php if(!empty($_POST['generate']) and !empty($shortcode)):?>
	    			<p class="srevo-help red"><?php _e('This shortcode should be placed only in "Text" mode of the rich text editor.', 'shortcode-revolution');?></p>			    
			    	<textarea cols="120" rows="10" readonly="readonly" onclick="this.select()"><?php echo esc_textarea($shortcode);?></textarea>
		    	<?php endif;?>
			</form>   	
